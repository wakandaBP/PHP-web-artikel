		...
		<div class="container">
			...
			<form action="#" method="">
				<div class="panel" style="border-top : thin solid #808080; margin-top: 20px;">
					<div style="margin-top: 20px;"><h4>Harap login untuk memberikan komentar!</h4></div>
                    ...
                    <div class="panel-body">
                    	<div class="form-group">
                    		...
                    		<input disabled type="text" class="form-control" id="judulkomentar" placeholder="Judul" />
                    	</div>

                        <div class="form-group">
                            <label for="isikomentar">Isi</label>
                            <textarea disabled class="form-control" id="isikomentar" rows="8" name="" placeholder="Isi Komentar"></textarea> 
                        </div> 
                    </div>
                    <div class="panel-footer">
                        <input disabled type="submit" class="btn btn-primary" value='Submit'>
                    </div>
                </div>
            </form>
